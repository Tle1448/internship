...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-white">
      {/* ส่วนเนื้อหาหลักด้านบน (แบ่งซ้าย-ขวา เต็มพื้นที่) */}
      <div className="flex flex-1">
        {/* Left panel: ฟอร์ม Login */}
        <div className="w-full md:w-[560px] lg:w-[560px] shrink-0 flex flex-col justify-center px-8 sm:px-12 py-10 overflow-y-auto">
