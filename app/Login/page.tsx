    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center p-4 font-sans">
      ...
      <div className="max-w-[480px] w-full bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] p-8 border border-gray-100">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">เข้าสู่ระบบ (Sign In)</h1>
          <p className="text-sm text-gray-500">กรุณากรอกบัญชีผู้ใช้งานเพื่อเข้าสู่ระบบ WU-InternShip</p>
        </div>
        ...
        <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="space-y-2">
            <label htmlFor="username" className="block text-sm font-semibold text-gray-700">
              บัญชีผู้ใช้งาน (Username / ID) <span className="text-red-500">*</span>
            </label>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-sm font-medium text-[#7678ED] hover:text-[#3D348B] transition-colors">
                ลืมรหัสผ่าน?
              </a>
            </div>
            <div className="relative">
              ...
              {/* ปุ่มเปิด/ปิดตาจะอยู่ตรงนี้ครับ */}
              <button
                type="button"
        ...
        <div className="mt-8 mb-6 relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-3 bg-white text-gray-500">หรือเข้าสู่ระบบด้วยช่องทางมหาวิทยาลัย</span>
          </div>
        </div>
