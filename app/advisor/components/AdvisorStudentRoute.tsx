...
import StudentDocuments from "../students/[id]/StudentDocuments";
import SupervisionForm from "./SupervisionForm";

type StudentView = "overview" | "documents" | "progress" | "supervision" | "evaluation" | "history";
...
export default function AdvisorStudentRoute({ id, recordId, view }: { id?: string; recordId?: string; view: StudentView }) {
  ...
  if (view === "documents") return <StudentDocuments student={student} />;
