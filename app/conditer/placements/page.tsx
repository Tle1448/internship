...
export default function PlacementsPage() {
  ...
  const confirm = async (placement: Placement) => {
    ...
    const { error: rpcError } = await supabase.rpc("confirm_placement_and_assign_advisor", { application_id: placement.id, advisor_id: advisorId, verification_note: notes[placement.id] || null });
